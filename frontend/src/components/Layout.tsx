...
import { Leaf, LogOut, Plus, LayoutDashboard, User, ChevronRight, ShieldCheck, ShoppingBag, Store, Package } from 'lucide-react'
      ...
      <header className="sticky top-0 z-50 glass border-b border-white/40 shadow-sm shadow-black/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          ...
          <nav className="flex items-center gap-1">
            ...
            <Link
              to="/orders"
              className={`flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-sm font-medium transition-all duration-150 ${isActive('/orders')
