    ...
    <div className="min-h-screen bg-gradient-to-br from-tea-800 via-tea-700 to-tea-600 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        ...
        <div className="flex items-center justify-center mb-6">
          <a
            href="/admin/login"
            className="text-xs text-violet-600 hover:text-violet-800 font-medium flex items-center gap-1 border border-violet-200 bg-violet-50 px-3 py-1.5 rounded-lg transition hover:bg-violet-100"
          >
